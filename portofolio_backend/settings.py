...
# Pour éviter d’écraser un fichier déjà existant avec le même nom
AWS_S3_FILE_OVERWRITE = False

# Rendre les fichiers publics automatiquement
AWS_DEFAULT_ACL = 'public-read'

# URL personnalisée avec la bonne région
AWS_S3_CUSTOM_DOMAIN = f'{AWS_STORAGE_BUCKET_NAME}.s3.{AWS_S3_REGION_NAME}.amazonaws.com'

# Pour générer les bonnes URLs des fichiers
MEDIA_URL = f'https://{AWS_S3_CUSTOM_DOMAIN}/'

# Stockage principal pour les fichiers médias (images, etc.)
